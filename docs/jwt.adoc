...
==== Request
|===
|*Body* |link:{definitionsDir}jwt/issueJWTReqDTO.html[IssueJWTReqDTO,role="popUp"]
|===

==== Response
|===
|*Cookie* |Paper-Refresh-Token |리프레쉬 토큰 발급
|*Body* |link:{definitionsDir}jwt/issueJWTResDTO.html[IssueJWTResDTO,role="popUp"] |-
|===
...
|*Body* |link:{definitionsDir}jwt/refreshJWTResDTO.html[RefreshJWTResDTO,role="popUp"] |-
|===
